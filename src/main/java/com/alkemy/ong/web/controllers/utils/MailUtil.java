...
public class MailUtil {
 ...
 private final String MAIL_UTIL = "<!doctype html>\n" +
            ...
            "                                                style=\"font-size: 24px;\"><strong>¡Felicitaciones y bienvenid@s a la comunidad Alkemy! </strong></span>\n" +
            "                                        </p>\n" +
            "                                        <p style=\"text-align: center;\">&nbsp;</p>\n" +
            "                                        <p style=\"text-align: justify;\"><span\n" +
            "                                                style=\"font-size: 16px;\">\n" +
            "                                            Estamos felices de darles la bienvenida a la #Aceleración de Alkemy \uD83D\uDE80\n" +
            "                                            Les estaré enviando calendar invites para algunos encuentros de warm-up pre-definidos.\n" +
            "                                            Empezamos el lunes 11/04 con la reunión de bienvenida a las 9:30 (será grabada por si no pueden asistir).\n" +
            "                                            Además, en la trayectoria coordinarán encuentros con sus mentores de acuerdo a la disponibilidad del grupo.\n" +
            "                                            No se asusten con la carga horaria, los primeros días son siempre un poco intensos en eventos \uD83D\uDE09.</span></p>\n" +
            "                                    </div>\n" +
            "\n" +
            "                                </td>\n" +
            "                            </tr>\n" +
